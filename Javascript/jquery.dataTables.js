...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Sin datos para mostrar" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Mostrando _START_ al _END_ del _TOTAL_ de entradas",
	...
	$.extend( extPagination, {
		...
		full: function ( page, pages ) {
			return [  'primero', 'anterior', 'siguiente', 'ultimo' ];
		},
		...
		simple_numbers: function ( page, pages ) {
			return [ 'previo', _numbers(page, pages), 'siguiente' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'primer', 'anterior', _numbers(page, pages), 'siguiente', 'ultimo' ];
		},
