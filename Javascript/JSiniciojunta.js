...
function salir() {
   ...
   /*GUARDADO EN MEMORIA LOCAL, COOKIE EL DATO*/ localStorage.setItem("USUARIOJUNTALOGUEADO", null);
    ...
    /*LAS PETICIONES AJAX DEL SISTEMA SE REALIZAN A LOS CONTROLADORES DE LA CARPETA CONTROLLERS, SIEMPRE UTILIZANDO EL VERBO POST, SE UTILIZA JQUERY PARA EL USO DE AJAX*/$.ajax({
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data.IDENTIFICACION == 0) {
                ...
                document.getElementById("espaciotrabajo").innerHTML = "<table id='tablaresumen'><tr><td colspan='2'><strong>" + data.NOMBRE + ' ' + data.PRIMER_APELLIDO + ' ' + data.SEGUNDO_APELLIDO + "</strong></td></tr> <tr><td id='columnaresumen' ></td><td> <h1><img class='round' src='/Fotos/" + data.IDENTIFICACION + ".jpg' alt='" + data.NOMBRE + ' ' + data.PRIMER_APELLIDO + ' ' + data.SEGUNDO_APELLIDO + "' onerror=this.src='Imagenes/img_usuario.png' width='50px' heigth='50px' /><p style= 'font-size:small'>Fecha de nacimiento: " + data.FECHA_NACIMIENTO + ", fecha de ingreso a la institución: " + data.FECHA_INGRESO_ICE + " direcci€on actual: " + data.DIRECCION + " tiene registrados los correos: " + data.EMAIL1 + " - " + data.EMAIL2 + " labora(ba) para el departamento: " + data.DEPARTAMENTO + " con el puesto: " + data.PUESTO + " teléfonos: " + data.TEL1 + " / " + data.TEL2 + " / " + data.CEL + "</p> <strong> <spam style='font-size:small'> Ultima actualizacion por: " + data.USUARIO.NOMBRE_COMPLETO + " la fecha: " + data.FEC_ULT_ACT + " </spam> </strong> </hr><br/><paper-button style= 'font-size:small' raised id=\'btndetalleasobiso\' onclick=\'cargaaso(" + uno + ")\'>Ver detalle ABS </paper-button><br/><br/><paper-button style= 'font-size:small' raised id=\'btndetallemutualidad\' onclick=\'cargamut(" + uno + ")\'>Ver detalle del fondo por defunción del asociado </paper-button></br></br><paper-button style= 'font-size:small' raised id=\'btndetalleasolidaridad\' onclick=\'cargasol(" + uno + ")\'>Ver detalle del fondo por defunción del familiar </paper-button><br/></td></tr></table>";
...
function cargaaso(iden) {
    ...
    $("#columnaresumen").append('<div id=\'espaciodetalle\' style="font-size:small"></div>');
    ...
    /*LAS PETICIONES AJAX DEL SISTEMA SE REALIZAN A LOS CONTROLADORES DE LA CARPETA CONTROLLERS, SIEMPRE UTILIZANDO EL VERBO POST, SE UTILIZA JQUERY PARA EL USO DE AJAX*/$.ajax({
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data.IDENTIFICACION.IDENTIFICACION == 0) {
                ...
                $("#espaciodetalle").append("<h2>Asobiso</h2><p> Estado actual en el fondo: " + data.ESTADO.DESCRIPCION + " forma de pago: " + data.METODO_PAGO.DESCRIPCION + " fecha de afiliación: " + data.FECHA_INGRESO + " saldo actual: " + data.MONTO + " Observaciones: " + data.OBSERVACIONES + "<br/> <strong> <spam style='font-size:small'> Ultima actualización por: " + data.USUARIO.NOMBRE_COMPLETO + " la fecha: " + data.FEC_ULT_ACT + " </spam> </strong> </p><paper-button raised id='botonpophistorialmut' onclick=\"devuelvetablahistorialdepagos('Asociacion'," + persona.identificacion + ")\">Mostrar historial</paper-button> ");
...
function devuelvetablahistorialdepagos(fondo, ide) {
    $("#espaciodetalle").remove();
    $("#columnaresumen").append('<div id=\'espaciodetalle\'></div>');
...
function cargaresumen(iden) {
    ...
    /*LAS PETICIONES AJAX DEL SISTEMA SE REALIZAN A LOS CONTROLADORES DE LA CARPETA CONTROLLERS, SIEMPRE UTILIZANDO EL VERBO POST, SE UTILIZA JQUERY PARA EL USO DE AJAX*/$.ajax({
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data == '') {
                $("#columnaresumen").append("No hay mas datos sobre esta persona");
            } else {
                // alert("Persona afiliada desde: " + data.FECHA_INGRESO);
                $("#columnaresumen").append('<div id=\'espaciodetalle\'></div>');
        ...
        /*CUALQUIER ERROR DE COMUNICACION CON EL API*/error: function (xhr, textStatus, errorThrown) {
            $("#columnaresumen").append("Error al cargar, favor volver a cargar");
        }
    });
                                ...
                                /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
                                    if (data.ID == 0) {
                                      ...
                                      /*ITERAMOS EL VECTOR DE DATOS RECUPERADO DESDE EL SERVIDOR*/  for (var ele in data) {
                                        ...
                                        alert("Todos los cambios fueron aprobados");
                                        pendientecambioestado();
                                    }
...
function apruebaprestamoequipo(uno, dos, tres) {
    /*AL CONSUMIR UN API POR AJAX, MUESTRA UN MSG AL USUAIRO Y BLOQUE LA PANTALLA PARA EVITAR DOBLE ENVIO DE LA INFORMACION*/$(document).ajaxStart(function () {
        ///*LIBRERIA DE JAVASCRIPT QUE PERMITE BLOQUEAR LA PANTALLA PARA EVITAR EL DOBLE ENVIO DE INFORMACION*/$.blockUI({ message: '<img width="100px" heigth ="100px" src="imagenes/cargando5.gif" /><hr>Un segundo..., talvez dos...' });
    ...
    persona.tipo = "6";
    persona.idsocio = uno;
    persona.numeroactivo = dos;
    persona.fechaprestamo = tres;
    persona.usrid = JSON.parse(localStorage.getItem("USUARIOJUNTALOGUEADO")).ID;
    persona.pssw = JSON.parse(localStorage.getItem("USUARIOJUNTALOGUEADO")).CONTRASENA;
    ...
    /*LAS PETICIONES AJAX DEL SISTEMA SE REALIZAN A LOS CONTROLADORES DE LA CARPETA CONTROLLERS, SIEMPRE UTILIZANDO EL VERBO POST, SE UTILIZA JQUERY PARA EL USO DE AJAX*/$.ajax({
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data.ID == 0) {
                ...
                alert("Prestamo de equipo aprobado");
                pendienteprestamoequipo();
            }
        }
    });
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data.ID == 0) {
              ...
              /*ITERAMOS EL VECTOR DE DATOS RECUPERADO DESDE EL SERVIDOR*/  for (var ele in data) {
                    ...
                    persona.tipo = "6";
                    persona.idsocio = data[ele].IDENTIFICACION.IDENTIFICACION;
                    persona.numeroactivo = data[ele].NUMERO_ACTIVO.NUMERO_ACTIVO;
                    persona.fechaprestamo = data[ele].FECHA_PRESTAMO;
                    persona.usrid = JSON.parse(localStorage.getItem("USUARIOJUNTALOGUEADO")).ID;
                    persona.pssw = JSON.parse(localStorage.getItem("USUARIOJUNTALOGUEADO")).CONTRASENA;
                ...
                alert("Todos los prestamos aprobados");
                pendienteprestamoequipo();
            }
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data.ID == 0) {
              ...
              /*ITERAMOS EL VECTOR DE DATOS RECUPERADO DESDE EL SERVIDOR*/  for (var ele in data) {
                    ...
                    persona.idfamiliar = data[ele].IDENTIFICACION_FAMILIAR.IDENTIFICACION_FAMILIAR.IDENTIFICACION;
                    persona.tipo = "5";
                    persona.usrid = JSON.parse(localStorage.getItem("USUARIOJUNTALOGUEADO")).ID;
                    persona.pssw = JSON.parse(localStorage.getItem("USUARIOJUNTALOGUEADO")).CONTRASENA;
                ...
                alert("Todas las defunciones de solidaridad aprobadas");
                pendientedefsol();
...
function apruebadefsol(uno, dos) {
    /*AL CONSUMIR UN API POR AJAX, MUESTRA UN MSG AL USUAIRO Y BLOQUE LA PANTALLA PARA EVITAR DOBLE ENVIO DE LA INFORMACION*/$(document).ajaxStart(function () {
        ///*LIBRERIA DE JAVASCRIPT QUE PERMITE BLOQUEAR LA PANTALLA PARA EVITAR EL DOBLE ENVIO DE INFORMACION*/$.blockUI({ message: '<img width="100px" heigth ="100px" src="imagenes/cargando5.gif" /><hr>Un segundo..., talvez dos...' });
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data.ID == 0) {
              ...
              /*ITERAMOS EL VECTOR DE DATOS RECUPERADO DESDE EL SERVIDOR*/  for (var ele in data) {
                ...
                alert("Todas las defunciones de mutualidad aprobadas");
                pendientedefmut();
...
function docs() {
    ...
    document.getElementById('espaciotrabajo').innerHTML = "<h2>Documentos para junta y afiliados  </H2> <hr><ul class='tabs' id='detalle' ></ul>";
    ...
    $('#tab-content0').append("<div id='listadoactualjunta'></div>");
    $('#tab-content1').append("<div id='listadoactualasociado'></div>");
    var persona = new Object();
        ...
        /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
            if (data.length == 0) {
              ...
              /*ITERAMOS EL VECTOR DE DATOS RECUPERADO DESDE EL SERVIDOR*/  for (var ele in data) {
                    ...
                    $('#listadoactualjunta').append('<table><tr><td><a href=' + data[ele].replace(/ /g, "%20") + ">" + data[ele].split('/')[(data[ele].split('/')).length - 1] + "</a></td></tr></table></br>");
                }
                var persona = new Object();
                    ...
                    /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
                        if (data.length == 0) {
                          ...
                          /*ITERAMOS EL VECTOR DE DATOS RECUPERADO DESDE EL SERVIDOR*/  for (var ele in data) {
                                ...
                                $('#listadoactualasociado').append('<table><tr><td><a href=' + data[ele].replace(/ /g, "%20") + ">" + data[ele].split('/')[(data[ele].split('/')).length - 1] + "</a></td></tr></table></br>");
                            }
