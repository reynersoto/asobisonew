...
var fechadepago = url.searchParams.get("fecpago");
...
function cargatabs() {
    ...
    if (JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")) != null) {
        if (JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).ESTADO.ID != 13) {
            if (JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).ESTADO.ID == 5) {
                ...
                $("#detalle").append("<li id='pagouno'> <input type='radio' checked name='tabs' id='tab0'><label for='tab0'>Pago de afiliación de mutualidad</label><div id='tab-content0' class='tab-content animated fadeIn'><H3> Saldo actual: " + JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).MONTO + " Estado " + JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).ESTADO.DESCRIPCION + " </H3> <paper-button raised id='cambioformadepagobtn' onclick='cambiofpafilmut()'>Por deposito bancario</paper-button><input type='text' class='form-control' placeholder='Identificacion del deposito' id='idpagoafilmutbanc' style='display:none;' onkeyup='corroborapagorepetido(this)'/> <input type='text' class='form-control' placeholder='Identificacion del pago' id='idpagoafilmut' disabled/> <input type='text' class='form-control' placeholder='Serie del pago' id='seriepagoafilmut' value = 'B'/><input  class='form-control' placeholder='Fecha del pago' id='fechapagoafilmut' type='date' value='" + hoy.format("yyyy-mm-dd") + "'> </paper-input> <input type='text' class='form-control' onkeyup='espaciador(this)' placeholder='Monto del pago' id='montopagoafilmut'/> <hr><paper-button raised id='pagoafilmut' onclick='pagaafilmut()'>Pagar</paper-button></div> </li>");
                ...
                $("#detalle").append("<li id='pagouno'> <input type='radio' checked name='tabs' id='tab0'><label for='tab0'>Pago de cuotas mutualidad</label><div id='tab-content0' class='tab-content animated fadeIn'><H3 id='titulomut'> Saldo actual: " + JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).MONTO + " Estado " + JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).ESTADO.DESCRIPCION + " </H3><paper-button raised id='cambioformadepagobtn' onclick='cambiofpmut()'>Por deposito bancario</paper-button><input type='text' class='form-control' placeholder='Identificacion del deposito' id='idpagomutbanc' onkeyup='corroborapagorepetido(this)' style='display:none;'/><input type='text' class='form-control' placeholder='Identificacion del pago' id='idpagomut' disabled /> <input type='text' class='form-control' placeholder='Serie del pago' id='seriepagomut'  value = 'B'/><input  class='form-control' placeholder='Fecha del pago' id='fechapagomut' type='date' value='" + hoy.format("yyyy-mm-dd") + "'> </paper-input> <input type='text' class='form-control' placeholder='Monto del pago' id='montopagomut' onkeyup=\"calculasaldo('MUTUALIDAD')\"/><hr><paper-button raised id='pagomut' onclick='pagamut()'>Pagar</paper-button></div> </li>");
                var persona = new Object();
                persona.operacion = "1";
                persona.usrid = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).ID;
                persona.pssw = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).CONTRASENA;
                ...
                /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
                    if (data.length == 0) {
                      ...
                      /*ITERAMOS EL VECTOR DE DATOS RECUPERADO DESDE EL SERVIDOR*/  for (var ele in data) {
                            ...
                            btnmodifica.setAttribute("onclick", "window.open('Adm_de_pagos.html?numpago=" + data[ele].IDENTIFICACION_PAGO + "&fondo=" + data[ele].FONDO + "','_blank')");
    ...
    if (JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")) != null) {
        ...
        if (JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).ESTADO.ID != 13) {
            if (JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).ESTADO.ID == 5) {
                ...
                $("#detalle").append("<li id='pagodos'> <input type='radio' checked name='tabs' id='tab1'><label for='tab1'>Pago de afiliación en solidaridad</label><div id='tab-content1' class='tab-content animated fadeIn'><H3> Saldo actual: " + JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).MONTO + "  Estado " + JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).ESTADO.DESCRIPCION + " </H3><paper-button raised id='cambioformadepagobtnsol' onclick='cambiofpafilsol()'>Por deposito bancario</paper-button><input type='text' class='form-control' placeholder='Identificacion del deposito' id='idpagoafilsolbanc' onkeyup='corroborapagorepetido(this)' style='display:none;'/> <input type='text' class='form-control' placeholder='Identificacion del pago' id='idpagoafilsol' disabled/> <input type='text' class='form-control' placeholder='Serie del pago' id='seriepagoafilsol'  value = 'A'/><input  class='form-control' placeholder='Fecha del pago' id='fechapagoafilsol' type='date' value='" + hoy.format("yyyy-mm-dd") + "'> </paper-input> <input type='text' class='form-control' onkeyup='espaciador(this)' placeholder='Monto del pago' id='montopagoafilsol'/> <hr><paper-button raised id='pagoafilsol'  onclick='pagaafilsol()'>Pagar</paper-button></div> </li>");
                var persona = new Object();
                persona.operacion = "1";
                persona.usrid = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).ID;
                persona.pssw = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).CONTRASENA;
                ...
                $("#detalle").append("<li id='pagodos'> <input type='radio' checked name='tabs' id='tab1'><label for='tab1'>Pago de cuotas solidaridad</label><div id='tab-content1' class='tab-content animated fadeIn'><H3 id='titulosol'> Saldo actual: " + JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).MONTO + "  Estado " + JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).ESTADO.DESCRIPCION + " </H3><paper-button raised id='cambioformadepagobtnsol' onclick='cambiofpsol()'>Por deposito bancario</paper-button><input type='text' class='form-control' placeholder='Identificacion del deposito' onkeyup='corroborapagorepetido(this)' id='idpagosolbanc' style='display:none;'/> <input type='text' class='form-control' placeholder='Identificacion del pago' id='idpagosol' disabled/> <input type='text' class='form-control' placeholder='Serie del pago' id='seriepagosol'  value = 'A'/><input  class='form-control' placeholder='Fecha del pago' id='fechapagosol' type='date' value='" + hoy.format("yyyy-mm-dd") + "'> </paper-input> <input type='text' class='form-control' placeholder='Monto del pago' id='montopagosol' onkeyup=\"calculasaldo('SOLIDARIDAD')\"/><hr><paper-button raised id='pagosol'  onclick='pagasol()'>Pagar</paper-button></div> </li>");
                var persona = new Object();
                persona.operacion = "1";
                persona.usrid = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).ID;
                persona.pssw = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).CONTRASENA;
    ...
    if (JSON.parse(localStorage.getItem("PERSONABUSCADAENASOBISO")) != null) {
        ...
        if (JSON.parse(localStorage.getItem("PERSONABUSCADAENASOBISO")).ESTADO != 13) {
            ...
            $("#detalle").append("<li id='pagotres'> <input type='radio' checked name='tabs' id='tab2'><label for='tab2'>Pago de cuotas en asobiso</label><div id='tab-content2' class='tab-content animated fadeIn'><H3> Saldo actual: " + JSON.parse(localStorage.getItem("PERSONABUSCADAENASOBISO")).MONTO + " Estado " + JSON.parse(localStorage.getItem("PERSONABUSCADAENASOBISO")).ESTADO.DESCRIPCION + " </H3><paper-button raised id='cambioformadepagobtnaso' onclick='cambiofpaso()'>Por deposito bancario</paper-button><input type='text' class='form-control' placeholder='Identificacion del deposito' id='idpagoasobanc' onkeyup='corroborapagorepetido(this)' style='display:none;'/> <input type='text' class='form-control' placeholder='Identificacion del pago' id='idpagoaso'/> <input type='text' class='form-control' placeholder='Serie del pago' id='seriepagoaso' value='S'/><input class='form-control' placeholder='Fecha del pago' id='fechapagoaso' type='date' value='" + hoy.format("yyyy-mm-dd") + "'> </paper-input> <input type='text' class='form-control' onkeyup='espaciador(this)' placeholder='Monto del pago' id='montopagoaso'/> <hr><paper-button raised id='pagoaso' onclick='pagaaso()'>Pagar</paper-button></div> </li>");
    ...
    if (JSON.parse(localStorage.getItem("PERSONABUSCADA")) != null) {
        ...
        $("#detalle").append("<li id='pagotres'> <input type='radio' checked name='tabs' id='tab3'><label for='tab3'>Pago de cuotas extraordinarias</label><div id='tab-content3' class='tab-content animated fadeIn'><paper-button raised id='cambioformadepagobtnotro' onclick='cambiofpotro()'>Por deposito bancario</paper-button><input type='text' class='form-control' placeholder='Identificacion del deposito' id='idpagootrobanc' style='display:none;'/> <input type='text' class='form-control' placeholder='Identificacion del pago' id='idpagootro'/> <input type='text' class='form-control' placeholder='Serie del pago' id='seriepagootro' value = 'O'/><input  class='form-control' placeholder='Fecha del pago' id='fechapagootro' type='date' value='" + hoy.format("yyyy-mm-dd") + "'> </paper-input> <input type='text' class='form-control' placeholder='Monto del pago' onkeyup='espaciador(this)' id='montopagootro'/> <input type='text' class='form-control' placeholder='Observaciones(detalle del pago)' id='obsotro' rows=\"5\"/> <hr><paper-button raised id='pagoafilotro' onclick='pagaotro()'>Pagar</paper-button></div> </li>");
    ...
    switch (idtipopago) {
        case 'MUTUALIDAD':
            if (document.getElementById("montopagomut").value != "") {
                ...
                //    sValue = document.getElementById("montopagomut").value + '';

                //while (sRegExp.test(sValue)) {
                //    sValue = sValue.replace(sRegExp, '$1 $2');
                //}
                if (document.getElementById("montopagomut").value.replace(' ', '').length > 3) {
                    if (document.getElementById("montopagomut").value.replace(' ', '').length < 7) {
                        ...
                        var montosinespacios = document.getElementById("montopagomut").value.replace(' ', '');
                        ...
                        document.getElementById("montopagomut").value = output;
                    } else {
                        var montosinespacios = document.getElementById("montopagomut").value.replace(' ', '').replace(' ', '');
                    ...
                    var montosinespacios = document.getElementById("montopagomut").value.replace(' ', '').replace(' ', '');
                    document.getElementById("montopagomut").value = montosinespacios;
                }

                //document.getElementById("montopagomut").value = document.getElementById("montopagomut").value.toLocaleString('en');
                var montoactual = parseFloat(JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).MONTO);
                var montoapagar = parseFloat(document.getElementById("montopagomut").value.replace(' ', '').replace(' ', ''));
                var montosaldo = parseFloat(montoactual) + parseFloat(montoapagar);
                ...
                /*LAS PETICIONES AJAX DEL SISTEMA SE REALIZAN A LOS CONTROLADORES DE LA CARPETA CONTROLLERS, SIEMPRE UTILIZANDO EL VERBO POST, SE UTILIZA JQUERY PARA EL USO DE AJAX*/$.ajax({
                    ...
                    /*CUANDO EL ERVIDOR ENVIA UNA RESPUESTA AFIRMATIVA*/success: function (data, textStatus, xhr) {
                        if (data.ID == 0) {
                            ...
                            $("#titulomut").append("<p id ='saldoactualizadomut' style='font size=\"small\";'>Su nuevo saldo seria de: ¢" + parseFloat(montosaldo) + " le alcanza hasta " + data + "</p>");
        ...
        case 'SOLIDARIDAD':
            if (document.getElementById("montopagosol").value != "") {
                ...
                //  var sRegExp = new RegExp('(-?[0-9]+)([0-9]{3})');
                //sValue = document.getElementById("montopagosol").value + '';
                ...
                if (document.getElementById("montopagosol").value.replace(' ', '').length > 3) {
                    if (document.getElementById("montopagosol").value.replace(' ', '').length < 7) {
                        // var output = [document.getElementById("montopagomut").value.slice(0, document.getElementById("montopagomut").value.length - 3), ' ', document.getElementById("montopagomut").value.slice(document.getElementById("montopagomut").value.length)].join('');
                        var montosinespacios = document.getElementById("montopagosol").value.replace(' ', '');
                        var output = [montosinespacios.slice(0, montosinespacios.length - 3), ' ', montosinespacios.slice(montosinespacios.length - 3, montosinespacios.length)].join('');
                        document.getElementById("montopagosol").value = output;
                    } else {
                        var montosinespacios = document.getElementById("montopagosol").value.replace(' ', '').replace(' ', '');
                        var output = [montosinespacios.slice(0, montosinespacios.length - 6), ' ', montosinespacios.slice(-6, montosinespacios.length - 3), ' ', montosinespacios.slice(montosinespacios.length - 3, montosinespacios.length)].join('');
                        document.getElementById("montopagosol").value = output;
                    ...
                    var montosinespacios = document.getElementById("montopagosol").value.replace(' ', '').replace(' ', '');
                    document.getElementById("montopagosol").value = montosinespacios;
                }
                //  document.getElementById("montopagosol").value = document.getElementById("montopagosol").value.replace(/\B(?=(\d{3})+(?!\d))/g, ',');
                var montoactual = JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).MONTO;
                var montoapagar = document.getElementById("montopagosol").value.replace(' ', '').replace(' ', '');
...
function pagaafilmut() {
    ...
    if (document.getElementById('alertadepagorepetido').innerHTML != '') {
        ...
        if (confirm("Desea agregar el pago, aun con la advertencia: " + document.getElementById('alertadepagorepetido').innerHTML) == true) {
            ...
            persona.MONTO = document.getElementById("montopagoafilmut").value.replace(' ', '').replace(' ', '');
            persona.usrid = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).ID;
            persona.pssw = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).CONTRASENA;
            persona.MONTOSALDO = 0;
...
function pagaafilsol() {
    ...
    if (document.getElementById('alertadepagorepetido').innerHTML != '') {
        ...
        if (confirm("Desea agregar el pago, aun con la advertencia: " + document.getElementById('alertadepagorepetido').innerHTML) == true) {
            ...
            persona.MONTO = document.getElementById("montopagoafilsol").value.replace(' ', '').replace(' ', '');
            persona.MONTOSALDO = 0;
    ...
    if (document.getElementById('alertadepagorepetido').innerHTML != '') {
        ...
        if (confirm("Desea agregar el pago, aun con la advertencia: " + document.getElementById('alertadepagorepetido').innerHTML) == true) {
            ...
            if (document.getElementById('seriepagomut').style.display != 'none') {
                ...
                persona.METODOPAGO = "1";
                tipopago = 1;
                // corroborapagorepetido(persona.TIPO, persona.METODOPAGO, persona.IDPAGO, persona.SERIEPAGO)
            } else {
            ...
            persona.MONTO = document.getElementById("montopagomut").value.replace(' ', '').replace(' ', '');
            var montoactual = JSON.parse(localStorage.getItem("PERSONABUSCADAENMUTUALIDAD")).MONTO
            var montoapagar = document.getElementById("montopagomut").value.replace(' ', '').replace(' ', '');
...
function pagasol() {
    ...
    if (document.getElementById('alertadepagorepetido').innerHTML != '') {
        ...
        if (confirm("Desea agregar el pago, aun con la advertencia: " + document.getElementById('alertadepagorepetido').innerHTML) == true) {
            ...
            persona.MONTO = document.getElementById("montopagosol").value.replace(' ', '').replace(' ', '');
            var montoactual = JSON.parse(localStorage.getItem("PERSONABUSCADAENSOLIDARIDAD")).MONTO
            var montoapagar = document.getElementById("montopagosol").value.replace(' ', '').replace(' ', '');
            persona.MONTOSALDO = parseInt(montoactual) + parseInt(montoapagar);
...
function pagaotro() {
    ...
    persona.TIPO = "OTRO";
    persona.METODOPAGO = "1";
    persona.MONTO = document.getElementById("montopagootro").value.replace(' ', '').replace(' ', '');
    persona.MONTOSALDO = document.getElementById("montopagootro").value.replace(' ', '').replace(' ', '');
    persona.usrid = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).ID;
    persona.pssw = JSON.parse(localStorage.getItem("USUARIOLOGUEADO")).CONTRASENA;
...
function pagaaso() {
    ...
    if (document.getElementById('alertadepagorepetido').innerHTML != '') {
        ...
        if (confirm("Desea agregar el pago, aun con la advertencia: " + document.getElementById('alertadepagorepetido').innerHTML) == true) {
            ...
            persona.MONTO = document.getElementById("montopagoaso").value.replace(' ', '').replace(' ', '');
            var montoactual = JSON.parse(localStorage.getItem("PERSONABUSCADAENASOBISO")).MONTO
            var montoapagar = document.getElementById("montopagoaso").value.replace(' ', '').replace(' ', '');
            persona.MONTOSALDO = parseInt(montoactual) + parseInt(montoapagar);
            ...
            if (document.getElementById('seriepagoaso').style.display != 'none') {
                ...
                persona.IDPAGO = document.getElementById("idpagoasobanc").value;
                persona.SERIEPAGO = 'A';
                persona.TIPO = "ASOCIACION";
                persona.METODOPAGO = "2";
                tipopago = 2;
...
function pagaequipo() {
    ...
    persona.TIPO = "EQUIPO";
    persona.METODOPAGO = "1";
    persona.MONTO = document.getElementById("montopagoequipo").value.replace(' ', '').replace(' ', '');
    persona.MONTOSALDO = document.getElementById("montopagoequipo").value.replace(' ', '').replace(' ', '');
...
function corroborapagorepetido(input) {
    if (input.value != '') {
        ...
        switch (input.id) {
            ...
            case "idpagoafilmutbanc": {

                persona.TIPO = 'MUTUALIDAD AFILIACION';
                break;
            }
            case "idpagoafilsolbanc": {
